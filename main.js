  ...
  if(cart.length==0){
    ...
    <div class="cartcase-content">
      ...
      <div class="cartcase-pb">
        ...
        `+"<button class='cart-menu-close'><ion-icon name='close-outline' role='img' class='md hydrated' aria-label='close outline' onclick='delElement("+ (j++) +")'></ion-icon></button></div></div></div>"
      );
    }).join('');
